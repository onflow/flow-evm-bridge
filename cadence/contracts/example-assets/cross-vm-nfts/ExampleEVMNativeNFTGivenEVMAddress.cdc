/* 
 *
 * This is an example implementation of an EVM-native cross-VM NFT. EVM-native here meaning that
 * the NFT is distributed in EVM and cross-VM meaning that the project is deployed across
...
access(all) contract ExampleEVMNativeNFTGivenEVMAddress: NonFungibleToken, ICrossVM, ICrossVMAsset {
    ...
    access(all) resource NFT: NonFungibleToken.NFT, ViewResolver.Resolver {
        ...
        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-ExampleEVMNativeNFTGivenEVMAddress.createEmptyCollection(nftType: Type<@ExampleEVMNativeNFTGivenEVMAddress.NFT>())
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return ExampleEVMNativeNFTGivenEVMAddress.resolveContractView(resourceType: Type<@ExampleEVMNativeNFTGivenEVMAddress.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                case Type<MetadataViews.EVMBridgedMetadata>():
                    // retrieve the token URI from the ERC721 as source of truth
                    let uri = ExampleEVMNativeNFTGivenEVMAddress.tokenURI(id: UInt256(self.id))

                    return MetadataViews.EVMBridgedMetadata(
                        name: ExampleEVMNativeNFTGivenEVMAddress.getName(),
                        symbol: ExampleEVMNativeNFTGivenEVMAddress.getSymbol(),
                ...
                case Type<CrossVMMetadataViews.EVMPointer>():
                    return CrossVMMetadataViews.EVMPointer(
                        ...
                        evmContractAddress: ExampleEVMNativeNFTGivenEVMAddress.getEVMContractAddress(),
    ...
    access(all) resource Collection: NonFungibleToken.Collection {
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@ExampleEVMNativeNFTGivenEVMAddress.NFT>()] = true
        ...
        access(all) view fun isSupportedNFTType(type: Type): Bool {
           if type == Type<@ExampleEVMNativeNFTGivenEVMAddress.NFT>() {
            return true
           } else {
            return false
           }
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            let token <- token as! @ExampleEVMNativeNFTGivenEVMAddress.NFT
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&ExampleEVMNativeNFTGivenEVMAddress.Collection>(),
                    publicLinkedType: Type<&ExampleEVMNativeNFTGivenEVMAddress.Collection>(),
            ...
            case Type<MetadataViews.EVMBridgedMetadata>():
                ...
                let uri = ExampleEVMNativeNFTGivenEVMAddress.contractURI()
                return MetadataViews.EVMBridgedMetadata(
                        name: ExampleEVMNativeNFTGivenEVMAddress.getName(),
                        symbol: ExampleEVMNativeNFTGivenEVMAddress.getSymbol(),
                        uri: MetadataViews.URI(baseURI: nil, value: uri)
            ...
            case Type<CrossVMMetadataViews.EVMPointer>():
                return CrossVMMetadataViews.EVMPointer(
                    cadenceType: Type<@ExampleEVMNativeNFTGivenEVMAddress.NFT>(),
    ...
    access(all) resource NFTMinter : FlowEVMBridgeCustomAssociationTypes.NFTFulfillmentMinter {
        ...
        access(all) view fun getFulfilledType(): Type {
            return Type<@ExampleEVMNativeNFTGivenEVMAddress.NFT>()
        }
    ...
    ///
    /// @param erc721Address: The hex-encoded ERC721 contract address to be associated with this NFT. If using a proxy,
    ///     this should be the proxy address, **not** the current implementation.
    ///
    init(erc721Address: String) {
        ...
        let collectionCap = self.account.capabilities.storage.issue<&ExampleEVMNativeNFTGivenEVMAddress.Collection>(self.CollectionStoragePath)
